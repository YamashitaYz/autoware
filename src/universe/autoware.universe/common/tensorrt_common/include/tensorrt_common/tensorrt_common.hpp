...
struct InferDeleter  // NOLINT
{
  void operator()(T * obj) const
  {
    if (obj) {
      ...
      delete obj;
//#else
//      obj->destroy();wheeltec  tues changes
#endif
    }
  }
};
...
public:
   ...
   */
  void setup();
  //wheeltec tues add:add enqueueV3 support to tensorrt_common
  //https://github.com/autowarefoundation/autoware.universe/pull/9018/files
